...
export default function AboutHero() {
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#faf8f3] text-[#1a1612]">
      ...
      <style>{`
        ...
        .animate-glowPulse-rev { animation: glowPulse 7s ease-in-out infinite reverse; }
        ...
        .play-btn-wrap:hover .play-ring-fill { transform: scale(1); }
      ...
      <div className="absolute inset-0">
        ...
        {/* Cream overlay */}
        <div className="absolute inset-0 bg-[#faf8f3]/82" />

        {/* Bottom fade */}
        <div className="absolute inset-0 bg-gradient-to-t from-[#faf8f3] via-[#faf8f3]/55 to-[#faf8f3]/30" />

        {/* Gold radial */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_85%_85%,rgba(197,158,42,0.13),transparent_50%)]" />

        {/* Top white radial */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_20%_10%,rgba(255,255,255,0.55),transparent_45%)]" />
      ...
      {/* White glow */}
      <div className="absolute top-10 left-10 w-[300px] h-[300px] bg-white/60 blur-[110px] rounded-full animate-glowPulse pointer-events-none" />

      {/* Gold glow */}
      <div className="absolute bottom-10 right-10 w-[260px] h-[260px] bg-[rgba(197,158,42,0.10)] blur-[100px] rounded-full animate-glowPulse-rev pointer-events-none" />
      ...
      <div className="absolute top-[120px] right-[200px] w-[160px] h-[160px] rounded-full border border-[rgba(197,158,42,0.07)] -rotate-[12deg] pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-14 w-full">
          <div className="max-w-3xl">
            ...
            <div className="hero-animate delay-1 inline-flex items-center gap-3 px-[22px] py-2 rounded-full border border-black/9 bg-white/82 backdrop-blur-xl mb-9 relative">
              ...
              <span className="font-jost text-[10px] font-light tracking-[0.35em] uppercase text-black/50">
                Luxury Architecture Studio
              </span>
            </div>

            {/* Heading */}
            <h1 className="font-cormorant hero-animate delay-2 text-[clamp(58px,8.5vw,112px)] leading-[0.88] tracking-[-0.03em] font-light">
              <span className="block text-[#1a1612]/90 font-light">Building</span>
              <span className="block text-[#1a1612]/65 italic font-light">Timeless</span>
              <span className="block text-[#C59E2A] font-semibold">Experiences</span>
            </h1>
            ...
            <div className="hero-animate delay-5 mt-10 flex flex-wrap items-center gap-6">
              ...
              {/* Primary */}
              <button className="btn-hero-primary relative overflow-hidden px-[34px] py-[14px] rounded-full border border-[#C59E2A] bg-transparent text-[#C59E2A] font-jost text-[11px] font-normal tracking-[0.2em] uppercase cursor-pointer transition-colors duration-[450ms]">
              ...
              <button className="play-btn-wrap flex items-center gap-4 bg-transparent border-none cursor-pointer">
                <div className="relative w-[52px] h-[52px] rounded-full border border-black/12 bg-white/70 backdrop-blur-xl flex items-center justify-center overflow-hidden">
                  ...
                  <div
                    ...
                    style={{
                      ...
                      borderColor: "transparent transparent transparent rgba(26,22,18,0.7)",
                      transition: "border-color 0.4s",
                    }}
                  />
                </div>
                <div>
                  <span className="font-jost text-[11px] font-light tracking-[0.1em] uppercase text-black/38 block">Watch</span>
                  <span className="font-cormorant text-[17px] font-normal italic text-[#1a1612]/82 block mt-[1px]">Our Story</span>
                </div>
              </button>
